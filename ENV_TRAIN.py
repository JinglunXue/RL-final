...
class Retail_Environment(object):
    ...
    def __init__(self, lifetime, leadtime, mean_demand, coef_of_var, max_order, cost_order, cost_outdate, cost_lost,
        ...
        self.lifetime = lifetime#m
        self.leadtime = leadtime#L

        #demand~gamma distribution
        self.mean_demand = mean_demand
        self.coef_of_var = coef_of_var

        self.max_order = max_order#action space should be limited：0,1,...,max_order
        ...
        self.FIFO = FIFO
        self.LIFO = LIFO
        self.time = time#how many episodes(1000)
